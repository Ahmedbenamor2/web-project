...
<main role="main">
    ...
    <h2>nom du groupe a supprimer </h2>
    ...
    <input type="text" id="classe" name="classe" class="form-control" required pattern="INFO[1-3]{1}-[A-E]{1}"
     title="Pattern INFOX-X. Par Exemple: INFO1-A, INFO2-E, INFO3-C" placeholder="nom de groupe a supprimer">
    <input type="submit" name="confirmation" class="btn btn-primary btn-block"></button>
    </form>
