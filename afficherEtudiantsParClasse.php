...
<select id="classe1" name="classe"  class="custom-select custom-select-sm custom-select-lg" onchange="selectelement()">
<?php 
...
function selectelement(){
    var x=document.getElementById("classe1").value;
    $.ajax({
url:"afficherEtudiantparclasseindex.php",
method:"POST",
data:{
    Classe2: x},
